...
function addEmployeeRestApi() {
  return _addEmployeeRestApi.apply(this, arguments);
}
function _addEmployeeRestApi() {
  _addEmployeeRestApi = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return fetch("https://j5igw9ry82.execute-api.eu-north-1.amazonaws.com/test/sampleapi", {
            method: 'POST',
            mode: 'cors',
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (addEmployeeRestApi);
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
//GET
var BASE_URL = "https://j5igw9ry82.execute-api.eu-north-1.amazonaws.com/test";
function getFunction(_x) {
  return _getFunction.apply(this, arguments);
}
function _getFunction() {
  _getFunction = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    var endpoint, response, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          endpoint = "".concat(BASE_URL, "/sampleapi?id=").concat(id);
          _context.prev = 1;
          _context.next = 4;
...
/* harmony import */ var _getfunction__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./getfunction */ "./src/getfunction.js");
/* harmony import */ var _addFunction__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./addFunction */ "./src/addFunction.js");
...
jokeBtn.addEventListener('click', _addFunction__WEBPACK_IMPORTED_MODULE_4__["default"]);
jokeBtn.addEventListener('click', (0,_getfunction__WEBPACK_IMPORTED_MODULE_3__["default"])('2'));
(0,_generateJoke__WEBPACK_IMPORTED_MODULE_0__["default"])();
console.log((0,_generateJoke__WEBPACK_IMPORTED_MODULE_0__["default"])());
fetch("https://j5igw9ry82.execute-api.eu-north-1.amazonaws.com/test").then(function (response) {
  return response.text();
}).then(function (data) {
